class Config:
    ...
    SHARED_MAX_FEATURES_START = 1
    SHARED_MAX_FEATURES_END = 80
    SHARED_MAX_FEATURES_STEP = 1
    SWEEP_GPU_IDS = [0, 1, 2, 3]
    FEATURE_SELECTOR_CACHE_ENABLED = True
    FEATURE_SELECTOR_CACHE_DIR = ".cache/feature_selector"
